...
const socialLinks = [
  {
    label: 'YouTube',
    href: 'https://youtube.com/@kune8i?si=w8k8G4S83g6E6IAd',
    paths: [
  ...
  {
    label: 'Instagram',
    href: 'https://www.instagram.com/allpppii/',
    paths: [
  ...
  {
    label: 'LinkedIn',
    href: 'www.linkedin.com/in/alfiansyah-sibyanurrizki',
    paths: [
  ...
  {
    label: 'Threads',
    href: 'https://www.threads.com/@allpppii',
    paths: [
  ...
  {
    label: 'TikTok',
    href: 'https://www.tiktok.com/@kuunnee',
    paths: [
      'M16.6 2c.4 3 2.1 4.8 5 5v3.4a8.1 8.1 0 0 1-4.9-1.6v6.9c0 3.5-2.8 6.3-6.5 6.3-3.6 0-6.5-2.7-6.5-6.2 0-3.8 3.3-6.8 7.5-6.2v3.6c-2-.6-3.8.7-3.8 2.6 0 1.5 1.2 2.6 2.8 2.6 1.6 0 2.8-1.2 2.8-2.8V2h3.6Z',
    ],
  },
]
